...
def render_html(db):
    ...
    html_path = os.path.join(
        profile['output.path'], profile['output.filename']) + '.html'
...
def render_pdf(db):
    ...
    pdfkit.from_string(html_string, output_path=os.path.join(
        profile['output.path'], profile['output.filename']) + '.pdf',
